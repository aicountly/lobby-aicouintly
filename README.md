...
glazed entrance, a reception counter with a receptionist behind it, a waiting
lounge with a sofa and armchairs, and a glazed meeting-room entrance with a
corridor behind it.
...
5. **Alt-tab away mid-walk.** Come back: you should be standing still, not still
   walking.
6. **Turn on reduced motion.** Destinations should arrive instantly, the
   character should stop swaying, and the mouth should stop moving — replies
   arrive as text only.
7. **Standard View.** The same three services, no canvas in the DOM.
8. **Walk up to the counter and ask something.** The chip at the top should go
   Waiting → Thinking → Answering, and the character's mouth should move while
   it answers. Ask to speak to a person: it should say plainly that nothing was
   sent and offer the enquiry journey.
9. **Press Talk, then close the panel.** The browser's microphone indicator must
   go out. It must never come on by itself.
